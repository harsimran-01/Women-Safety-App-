...
//
//import eu.tutorials.womensafetyapp.ContactsAdapter;
//import eu.tutorials.womensafetyapp.R;
//import eu.tutorials.womensafetyapp.TrackingStopReceiver;
//
...
//            String channelName = "Background Tracking";
//            String channelDesc = "Notifies about background location tracking";
...
//        boolean callPermission = ContextCompat.checkSelfPermission(this, Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED;
//
...
//                smsManager.sendTextMessage(contact, null, message, null, null);
//            }
//            // Optionally show Toast or Snackbar on UI thread
//            runOnUiThread(() -> Toast.makeText(MainActivity.this, "Auto SOS sent", Toast.LENGTH_SHORT).show());
//        } catch (Exception e) {
